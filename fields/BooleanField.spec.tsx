...
describe('<BooleanField />', () => {
  it('should display tick and truthy text if value is true', () => {
    ...
    expect(screen.queryByLabelText('boolean.true')).not.toBeNull();
    expect(screen.queryByLabelText('boolean.true').dataset.testid).toBe(
      'true'
    );
    expect(screen.queryByLabelText('boolean.false')).toBeNull();
  });
  ...
  it('should use valueLabelTrue for custom truthy text', () => {
    ...
    expect(screen.queryByLabelText('boolean.true')).toBeNull();
  ...
  it('should display cross and falsy text if value is false', () => {
    ...
    expect(screen.queryByLabelText('boolean.true')).toBeNull();
    expect(screen.queryByLabelText('boolean.false')).not.toBeNull();
    expect(screen.queryByLabelText('boolean.false').dataset.testid).toBe(
      'false'
    );
  });
