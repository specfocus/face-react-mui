...
import type { SortPayload } from '@specfocus/view-focus.data/operations/SortPayload';
import type { FilterPayload } from '@specfocus/view-focus.data/operations/FilterPayload';
import type { ListControllerProps } from '@specfocus/view-focus/lists/useListController';
...
import { useReferenceArrayFieldController } from '@specfocus/view-focus/forms/useReferenceArrayFieldController';
 ...
 * </ReferenceArrayField>
 */
export const ReferenceArrayField: FunctionComponent<ReferenceArrayFieldProps> = props => {
  const {
    filter,
    page = 1,
    perPage,
...
export const ReferenceArrayFieldView: FunctionComponent<ReferenceArrayFieldViewProps> = props => {
