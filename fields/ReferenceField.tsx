...
import { useReference, UseReferenceResult } from '@specfocus/view-focus/lists/useReference';
...
export interface ReferenceFieldProps<RecordType extends Entity = any>
 ...
 */
export const NonEmptyReferenceField: FunctionComponent<
...
export const ReferenceFieldView: FunctionComponent<ReferenceFieldViewProps> = props => {
  const {
    children,
    className,
    error,
