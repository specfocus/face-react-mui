import { Form, FormProps } from '@specfocus/view-focus/forms/Form';
 ...
 *     BooleanInput,
 *     EditButton
 * } from '@specfocus/view-focus.mui-demo';
 *
...
export const findTabsWithErrors = (children, errors) => {
  console.warn(
    'Deprecated. FormTab now wrap their content inside a FormGroupContextProvider. If you implemented custom forms with tabs, please use the FormGroupContextProvider. See https://marmelab.com/@specfocus/view-focus.mui-demo/EditTutorial.html#grouping-inputs'
  );
