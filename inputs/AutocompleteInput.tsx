...
export const AutocompleteInput = <
  OptionType extends Entity = Entity,
...
>(
  ...
  const {
    choices: choicesProp,
    className,
    clearText = 'action.clear_input_value',
...
>(
  ...
  const [selectedChoice, setSelectedChoice] = useState<Entity | Entity[]>(
    () => getSelectedItems(choices, value, optionValue, multiple)
  );
