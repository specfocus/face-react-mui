...
export const SelectInput = (props: SelectInputProps) => {
  ...
  const handleChange = useCallback(
    async (eventOrChoice: ChangeEvent<HTMLInputElement> | Entity) => {
    ...
    <>
      ...
      >
        <MenuItem
          value={emptyValue}
          key="null"
          aria-label={translate('action.clear_input_value')}
          title={translate('action.clear_input_value')}
        >
...
export type SelectInputProps = Omit<CommonInputProps, 'source'> &
  ...
  Omit<TextFieldProps, 'label' | 'helperText' | 'classes' | 'onChange'> & {
    ...
    source?: string;
    onChange?: (event: ChangeEvent<HTMLInputElement> | Entity) => void;
  };
