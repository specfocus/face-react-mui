  ...
  return (
    <Fragment>
      ...
      <Root className={className} {...rest}>
        ...
        <div>{translate('message.error')}</div>
            ...
            <div className={ErrorClasses.advice}>
              ...
              <Typography component="div">
                <ul>
                  <li>
                    Check the{' '}
                    <a href="https://marmelab.com/@specfocus/view-focus.mui-demo/Readme.html">
                      @specfocus/view-focus.mui-demo documentation
                    </a>
                  </li>
                  <li>
                    Search on{' '}
                    <a href="https://stackoverflow.com/questions/tagged/@specfocus/view-focus.mui-demo">
                      StackOverflow
                    </a>{' '}
                  ...
                  <li>
                    ...
                    <a href="https://marmelab.com/ra-enterprise/#fromsww">
                      @specfocus/view-focus.mui-demo Enterprise Edition
                    </a>
                  </li>
                </ul>
              </Typography>
