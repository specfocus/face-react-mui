 ...
 * It is usually used as a child of @specfocus/view-focus.mui-demo's <List> and <ReferenceManyField> components.
 *
 ...
 * );
 */
export const SimpleList = <RecordType extends Entity = any>(
...
export type FunctionToElement<RecordType extends Entity = any> = (
  record: RecordType,
  id: Identifier
) => ReactNode;

export interface SimpleListProps<RecordType extends Entity = any>
...
export type FunctionLinkType = (record: Entity, id: Identifier) => string;
