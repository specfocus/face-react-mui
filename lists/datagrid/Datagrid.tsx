...
import { BulkDeleteButton } from '../../buttons';
 ...
 * }
 */
export const Datagrid: FunctionComponent<DatagridProps> = React.forwardRef((props, ref) => {
  const {
    optimized = false,
...
export interface DatagridProps<RecordType extends Entity = any>
